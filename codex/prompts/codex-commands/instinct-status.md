...
```bash
python3 "${CODEX_COMPANION_ROOT}/skills/continuous-learning-v2/scripts/instinct-cli.py" status
```

Or if `CODEX_COMPANION_ROOT` is not set (manual installation), use:
