...
```bash
node "${CODEX_COMPANION_ROOT}/scripts/skills-health.js" --dashboard
```

For a specific panel only:

```bash
node "${CODEX_COMPANION_ROOT}/scripts/skills-health.js" --dashboard --panel failures
```

For machine-readable output:

```bash
node "${CODEX_COMPANION_ROOT}/scripts/skills-health.js" --dashboard --json
```
