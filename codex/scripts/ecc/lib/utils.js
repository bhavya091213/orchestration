/**
 * Cross-platform utility functions for Codex workflow scripts
...
/**
 * Backwards-compatible alias used by migrated ECC scripts.
 */
...
function getSessionIdShort(fallback = 'default') {
  const sessionId = process.env.CODEX_SESSION_ID || process.env.CODEX_SESSION || process.env.CLAUDE_SESSION_ID;
