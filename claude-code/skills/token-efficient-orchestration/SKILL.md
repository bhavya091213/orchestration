...
- First use search tools or local knowledge helpers when available.
- Default search budget: 5 focused results or about 8k chars.
- For small tasks: 3 focused results or about 4k chars.
- Read file slices, not whole large files.
